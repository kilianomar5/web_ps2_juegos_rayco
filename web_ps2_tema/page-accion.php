...
<main class="pagina-categoria">
  <div class="contenedor">
    <header class="categoria-header">
      ...
      <p>Descubre los mejores títulos de acción para PlayStation 2.</p>
    </header>
    ...
    <section class="videojuegos-grid">
      ...
      $videojuegos_accion = new WP_Query($args);

      if ($videojuegos_accion->have_posts()) :
        while ($videojuegos_accion->have_posts()) : $videojuegos_accion->the_post();
      ...
      ?>
          <article class="videojuego-card">
            ...
            <div class="videojuego-info">
              <h2><?php the_title(); ?></h2>
<a href="<?php echo home_url('/fortnite'); ?>" class="boton-leer-mas">Ver Detalles</a>
