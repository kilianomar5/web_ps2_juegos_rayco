<?php
/*
Template Name: Página Aventuras
*/
get_header();
?>
...
<main class="pagina-categoria">
  <div class="contenedor">
    <header class="categoria-header">
      <h1>Juegos de Aventuras</h1>
      <p>Descubre los mejores títulos de aventuras para PlayStation 2.</p>
    </header>
    ...
    <section class="videojuegos-grid">
      ...
      $videojuegos_aventuras = new WP_Query($args);

      if ($videojuegos_aventuras->have_posts()) :
        while ($videojuegos_aventuras->have_posts()) : $videojuegos_aventuras->the_post();
      ...
      ?>
          <article class="videojuego-card">
            ...
            <div class="videojuego-info">
              <h2><?php the_title(); ?></h2>
<a href="<?php echo home_url('/the-last-of-us'); ?>" class="boton-leer-mas">Ver Detalles</a>
