...
<main class="pagina-categoria">
  <div class="contenedor">
    <header class="categoria-header">
      ...
      <p>Descubre los mejores títulos de carreras para PlayStation 2.</p>
    </header>
    ...
    <section class="videojuegos-grid">
      ...
      $videojuegos_carreras = new WP_Query($args);

      if ($videojuegos_carreras->have_posts()) :
        while ($videojuegos_carreras->have_posts()) : $videojuegos_carreras->the_post();
